 ...
 */
bool Position::isAttacked(int targetSquare, int attackerPiece, const vector<int>& directions) {
  assert(Square::isValid(targetSquare));
 ...
 */
bool Position::isAttacked(int targetSquare, int attackerPiece, int queenPiece, const vector<int>& directions) {
  assert(Square::isValid(targetSquare));
  assert(Piece::isValid(attackerPiece));
