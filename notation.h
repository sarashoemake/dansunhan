...
class Notation {
public:
  static const string STANDARDPOSITION;

  static Position toPosition(const string& fen);
  static string fromPosition(const Position& position);
  ...
  static int toSquare(const string& notation);
  static string fromSquare(int square);
